...
#define APP_ID "cn.xiaoxiaoge.Market"
//----这是什么----
//这是您的插件名称,一个独一无二的名称
//----我应该按照什么原则命名----
...
//默认已经写入
/*
$(SolutionDir)App\CQ_Json.exe $(ProjectDir) $(TargetDir)
*/

// 应用名称
#define APP_name "懒人引流"

// 应用版本
#include "appVer.h"

// 应用作者
#define APP_author "懒人引流"

//一句话描述插件用途
#define APP_description "懒人精准智能引流\r\n温馨提醒：用懒人引流，不会影响您开法拉利" //注释不影响解析效果
...
//酷Q目录,直接生成到酷Q目录
#define CQ_DIR "D:\\用户文档\\桌面\\桌面整理\\酷Q\\"
